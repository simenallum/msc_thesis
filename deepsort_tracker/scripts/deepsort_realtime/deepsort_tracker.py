...
from deepsort_realtime.deep_sort import nn_matching
from deepsort_realtime.deep_sort.detection import Detection
from deepsort_realtime.deep_sort.tracker import Tracker
from deepsort_realtime.utils.nms import non_max_suppression
    ...
    def __init__(
        ...
        if embedder is not None:
            ...
            if embedder == "mobilenet":
                from deepsort_realtime.embedder.embedder_pytorch import (
                ...
                from deepsort_realtime.embedder.embedder_pytorch import TorchReID_Embedder as Embedder
                ...
                from deepsort_realtime.embedder.embedder_clip import (
